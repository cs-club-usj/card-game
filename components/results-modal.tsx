...
export default function ResultsModal({ results, onRestart }: ResultsModalProps) {
  ...
  return (
    <div className="bg-gray-800 p-8 rounded-lg max-w-md w-full">
      ...
      <div className="mb-6 text-center">
        <p className={`text-xl ${correctMin && correctMax ? "text-green-400" : "text-red-400"}`}>{getMessage()}</p>
      </div>
